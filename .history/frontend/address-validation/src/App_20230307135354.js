...
function App() {
  ...
  return (
    ...
    <div className='  py-10 flex flex-col items-center border-2 border-black'>
      ...
      <button type="submit" onClick={findAddress} className=" mt-10 bg-black cursor-pointer text-lg font-medium before:absolute before:inset-x-0 before:-bottom-1.5 before:h-0.5 before:origin-left before:scale-x-0 before:transform before:rounded-bl before:bg-black before:transition-all before:duration-200 hover:before:scale-x-100">
          Submit
        </button>
