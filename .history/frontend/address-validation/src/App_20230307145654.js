    ...
    <div className=" items-center justify-between min-h-screen  ">
      <div className="  py-10 flex flex-col items-center border-2 border-black">
        ...
        <div className=" bg-green-300 mt-3">
          <select className=" cursor-pointer p-5" multiple value={countryList} onChange={handleSelectedCountry}>
            {countries.map((country) => (
              <option className=" uppercase tracking-widest" key={country.name} value={country.name}>
                {country.name}
              </option>
            ))}
          </select>
