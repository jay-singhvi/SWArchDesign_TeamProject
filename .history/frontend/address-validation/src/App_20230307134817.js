...
function App() {
  ...
  return (
    ...
    <div className='  py-10 flex flex-col items-center border-2 border-black'>
      ...
      <button type="submit" onClick={findAddress} className=" mt-10 bg-black cursor-pointer px-8 py-3 rounded-lg text-white uppercase tracking-widest hover:bg-slate-700">
          Submit
        </button>
