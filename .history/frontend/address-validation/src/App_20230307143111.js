...
function USAForm({ setFormData }) {
  ...
  return (
    <div className=" bg-gradient-to-b from-blue-700 to-red-500 items-center mt-10 px-10 py-5">
      <div>
        <form>
...
function CanadaForm({ setFormData }) {
  ...
  return (
    <div className="bg-gradient-to-b from-blue-700 to-red-500">
      <form>
        <div className=" flex items-center justify-center space-x-2">
...
function IndiaForm({ setFormData }) {
  ...
  return (
    <div className=" bg-gradient-to-b from-orange-400 to-green-500">
      <form>
        <div className=" flex items-center justify-center space-x-2">
