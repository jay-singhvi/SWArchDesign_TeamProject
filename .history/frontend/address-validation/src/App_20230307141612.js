  ...
  return (
    <div className=' items-center justify-between min-h-screen  '>
      <div className='  py-10 flex flex-col items-center border-2 border-black'>
        <h1 className=' uppercase tracking-widest font-bold text-xl'>Address Validator</h1>
        ...
        <a href="#_" class="relative inline-block text-lg group mt-10">
          <span class="relative z-10 block px-5 py-3 overflow-hidden font-medium leading-tight text-gray-800 transition-colors duration-300 ease-out border-2 border-gray-900 rounded-lg group-hover:text-white">
            ...
            <button type="submit" onClick={findAddress} className=" relative uppercase tracking-widest text-sm">
              Submit
            </button>
          </span>
  ...
  return (
    ...
    <div>
      <form>
        ...
        <h2 className=' uppercase tracking-wider font-medium'>United States Form</h2>
        </div>
  ...
  return (
    <div>
      ...
      <div className=' flex items-center justify-center space-x-2'>
        ...
        <h2 className=' uppercase tracking-wider font-medium'>Canada Form</h2>
        </div>
        Name: <input type="text" name="Name" onChange={updateForm} />
        <br />
        Address1: <input type="text" name="Address1" onChange={updateForm} />
...
function IndiaForm({ setFormData }) {
  ...
  return (
    <div>
      <form>
        <h2 className=' uppercase tracking-wider font-medium'>India Form</h2>
        Name: <input type="text" name="Name" onChange={updateForm} />
        <br />
