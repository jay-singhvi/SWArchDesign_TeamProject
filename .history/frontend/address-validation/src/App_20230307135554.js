...
function App() {
  ...
  return (
    ...
    <div className='  py-10 flex flex-col items-center border-2 border-black'>
      ...
      <button type="submit" onClick={findAddress} className=" mt-10 bg-black cursor-pointer px-8 py-2 rounded-lg text-white ">
          Submit<a href="#_" class="relative inline-block text-lg group">
